...
class Scanner():
	...
	def about(self):
		...
		print(colored("# author      :", "green") + "SWANTEX")
		print(colored("# linkedin    :", "green") + "https://www.instagram.com/swantexofc")
		print(colored("# github      :", "green") + "https://github.com/swantex")
		...
		print(colored("# date        :", "green") + "19.02.2023")
